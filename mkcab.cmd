...
stampinf -d * -v * -f win2k\zero.inf -a NTx86 || goto :eof
stampinf -d * -v * -f winnet\zero.inf -a NTx86,NTamd64,NTia64 || goto :eof
stampinf -d * -v * -f win7\zero.inf -a NTx86,NTamd64,NTia64,NTARM,NTARM64 || goto :eof
